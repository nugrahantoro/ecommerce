...
class Tutorial extends CI_Controller
{
  ...
  public function update($id)
  {
    ...
    $this->data['tutorial'] = $this->Tutorial_model->get_by_id($id);

    if ($row)
    {
      // if($this->session->userdata("company_id") != $row->)
      // {
      $this->data['title']          = 'Update Tutorial';
      $this->data['action']         = site_url('admin/tutorial/update_action');
