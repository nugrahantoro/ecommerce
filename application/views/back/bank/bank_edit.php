              ...
              <div class="box-body">
								...
								<?php echo form_open($action);?>
									<div class="form-group"><label>Nama Bank</label>
										<?php echo form_input($nama_bank, $bank->nama_bank);?>
									</div>
									<div class="form-group"><label>Atas Nama</label>
										<?php echo form_input($atas_nama, $bank->atas_nama);?>
									</div>
                  <div class="form-group"><label>Np. Rekening</label>
										<?php echo form_input($norek, $bank->norek);?>
									</div>
									<?php echo form_input($id_bank,$bank->id_bank);?>
